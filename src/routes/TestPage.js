...
function TestPage(props) {
  ...
  const [data] = useState({
    ...
    3: {
      ques: "부랄친구 10년 안 만나기 vs 장기자랑 10분 하기",
      ans1: "1 : 장기자랑 재미있지! 장기자랑 10분 해야지~",
      ans2: "2 : 친한 친구를 10년 못 보더라도 장기자랑은 못하겠어.. 부랄친구 10년 안 만날래",
    },
    4: {
      ques: "내일 여행을 간다면?",
    ...
    11: {
      ques: "밥을 먹으로 인터넷으로 찾은 맛집에 왔는데 문을 닫았다. 내 머리속의 생각은?",
